...
Installation is a simple gem install.  You may find it useful to create a ~/.gizmorc file, which is simply YAML key/values.  The keys are the long-style command line option keys converted into Ruby-style variables.  A common .gizmorc will simply be:
