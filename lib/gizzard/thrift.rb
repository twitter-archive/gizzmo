...
module Gizzard
  ...
  class Manager < GizzmoService
    ...
    thrift_method :repair_shard, void, field(:source_id, struct(ShardId), 1), field(:destination_id, struct(ShardId), 2), field(:table_id, i32, 3), field(:dry_run, i32, 4), :throws => exception(GizzardException)
